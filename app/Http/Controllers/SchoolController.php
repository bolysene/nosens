...
class SchoolController extends Controller
{
  public function __construct()
  {
    ...
    public function store(Request $request)
    {
      ...
      $tb->code = "SN-".date("d")."-".date('Y')."-".rand(0,100);
      $tb->theme = 'flatly';
      $tb->save();
      return back()->with('status', $request->school_name.' a été ajouté à notre liste d\'écoles');
    }
    ...
    public function addDepartment(Request $request){
      ...
      $s->save();
      return back()->with('status', $request->department_name.' crée avec succès');
    }
