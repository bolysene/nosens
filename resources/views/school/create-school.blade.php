...
@section('title', 'Gérer vos écoles')
            ...
            <div class="panel panel-default">
              <div class="panel-body table-responsive">
                @if(\Auth::user()->role == 'master')
                  ...
                  <h3 class="text-center text-danger">Liste des Ecoles</h3>
                @endif
                <div class="row"></div>
                <h4>Gérer les départements, les classes, les fillières, la promotion des étudiants, les cours.</h4>
                <div class="row"></div>
                <table class="table table-condensed" style="{{(\Auth::user()->role == 'master')?'':'width:800px'}}">
                  <thead class="thead-dark">
                    <tr>
                      @if(\Auth::user()->role == 'master')
                        ...
                        <th scope="col">Description de l'école</th>
                      @endif
                      ...
                      @if(\Auth::user()->role == 'master')
                        ...
                        <th scope="col">Voir les Admins</th>
                      @endif
                    </tr>
                  </thead>
                  <tbody>
                  @foreach($schools as $school)
                    ...
                    <tr>
                      @if(\Auth::user()->role == 'master')
                      <td class="table-striped ">{{($loop->index + 1)}}</td>
                      <td class="table-striped "><small>{{$school->name}}</small></td>
                      <td class="table-striped "><small>{{$school->code}}</small></td>
                      <td class="table-striped "><small>{{$school->about}}</small></td>
                      @endif
                      ...
                      <td>
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#departmentModal">+ Créer Filière</button>
                        <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <h4 class="modal-title" id="departmentModalLabel">Créer département</h4>
                                        </div>
