...
<head>
    ...
    <title>@yield('title') - {{ (Auth::check() && (Auth::user()->role == 'student' || Auth::user()->role == 'teacher'
        ...
        'librarian'))?Auth::user()->school->name:'Gestionnaire Ecole' }}</title>
    <style>
        .loader {
            position: fixed;
            left: 0px;
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/home') }}" style="color: #000;">
                        ...
                        Auth::user()->role == 'admin' || Auth::user()->role == 'accountant' || Auth::user()->role ==
                        'librarian'))?Auth::user()->school->name:'Gestionnaire Ecoles' }}
                    </a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="{{url('user/'.Auth::user()->student_code)}}">Profil</a>
                                </li>
                                @endif
                                <li>
