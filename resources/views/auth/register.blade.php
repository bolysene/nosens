    ...
    <div class="row">
        ...
        <div class="col-md-3" id="side-navbar">
            <ul class="nav flex-column">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ url('create-school') }}"><i class="material-icons">gamepad</i> <span class="nav-link-text"> Retour à la page précédente</span></a>
                </li>
            </ul>
        </div>
        @endif
        <div class="col-md-9" id="main-container">
            ...
            <div class="card card-group">
                <div class="page-panel-title">Créer un {{ucfirst(session('register_role'))}}</div>
                <div class="row"></div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="registerForm" action="{{ url('register/'.session('register_role')) }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Nom entier</label>
                        ...
                        <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                            <label for="phone_number" class="col-md-4 control-label">Numéro de téléphone</label>
                        ...
                        <div class="form-group{{ $errors->has('section') ? ' has-error' : '' }}">
                            <label for="section" class="col-md-4 control-label">Classe filieres</label>
                        ...
                        <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                            <label for="department" class="col-md-4 control-label">Département</label>
                        ...
                        <div class="form-group{{ $errors->has('class_teacher') ? ' has-error' : '' }}">
                            <label for="class_teacher" class="col-md-4 control-label">Professeur de classe</label>

                            <div class="col-md-6">
                                <select id="class_teacher" class="form-control" name="class_teacher_section_id">
                                    <option selected="selected" value="0">Pas de professeur de classe</option>
                                    @foreach (session('register_sections') as $section)
                                    <option value="{{$section->id}}">Section: {{$section->section_number}} Class:
                                        {{$section->class->class_number}}</option>
                                    @endforeach
                        ...
                        <div class="form-group{{ $errors->has('blood_group') ? ' has-error' : '' }}">
                            <label for="blood_group" class="col-md-4 control-label">Groupe sanguin</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Téléverser votre photo de profil</label>
                            <div class="col-md-6">
